...
try
{
	...
	class UserDialog extends Form {
		...
		function UserDialog() {
			this.Text = "Selected Track Add Any Time Gap";
			...
			inputBox = addTextControl("Input TimeCode", int(titleBarWidth/3), this.ClientSize.Width-titleBarWidth-2, 20, twoSecondGap);
			
			
			var titleLabel = new Label();
			titleLabel.AutoSize = true;
			titleLabel.Text = "Gap(Hours:minutes:seconds.frames):";
			...
			aboutLabel.Text = "by KindKind, 04/2020 Improved Ver.";
